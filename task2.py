...
it dont print the statement
it just gives the description about some code
"""
# declare and print
number = 40
name = "python"
...
print("a:",a)
print("b:",b)
#datatype and varaible
x = 10
print("The data type of variable x",type(x))
y="pythonlife"
print("The data type of varaible y",type(y))
#memory address
x = 10
y = 1
